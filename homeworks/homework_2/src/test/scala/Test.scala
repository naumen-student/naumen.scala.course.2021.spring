...
object Test extends TestSuite{
    ...
    val tests = Tests{
        ...
        'sumScalars - {
            assert(Exercises.sumScalars(Vector2D(1, 0), Vector2D(1,6), Vector2D(2, 6), Vector2D(2,6)) == 41)
            assert(Exercises.sumScalars(Vector2D(1, 0), Vector2D(1,0), Vector2D(1, 0), Vector2D(1,0)) == 2)
            assert(Exercises.sumScalars(Vector2D(0, 0), Vector2D(0,0), Vector2D(0, 0), Vector2D(0,0)) == 0)
            assert(Exercises.sumScalars(Vector2D(3, 4), Vector2D(5,6), Vector2D(7, 2), Vector2D(1,1)) == 48)
