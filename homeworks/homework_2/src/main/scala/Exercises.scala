...
object Exercises {
  ...
  def sumByFunc(leftVec0: Vector2D, leftVec1: Vector2D, functionToSum: (Vector2D, Vector2D) => Double, rightVec0: Vector2D, rightVec1: Vector2D): Double = {
    functionToSum(leftVec0, leftVec1) + functionToSum(rightVec0, rightVec1)
  }
